...
C.volna = '/root/dev/Modified_TorchSSC_/'      # this is the path to your repo 'TorchSSC'


"""please config ROOT_dir and user when u first using"""
C.repo_name = 'Modified_TorchSSC_'
...
C.data_root = '/root/data/sketch_sscnet'

C.dataset_path = osp.join(C.data_root, 'DATA/NYU/')
